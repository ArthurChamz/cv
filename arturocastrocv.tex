...
\section{Languages}
\cvdoubleitem{Spanish}{Native Language}{English}{Professional}
\cvitem{French}{Intermediate}
%\cvitemwithcomment{French}{Intermediate}{Comment}

\section{Skills}
%\subsection{Programming Languages}
\cvitem{Programming}{C, C\texttt{++}, C\texttt{\#} \includegraphics{net}, Java \includegraphics{java}, Python \includegraphics{python}, Ruby \includegraphics{ruby}, Perl \includegraphics{perl}, VBasic, Javascript \includegraphics{js}, HTML \includegraphics{html}, CSS, XML.}
\cvitem{Databases}{Relational design, modeling and operation (PostgreSQL \includegraphics{psql}, SQL Server \includegraphics{tsql}, MySQL \includegraphics{mysql}).}
\cvitem{Platforms}{Linux \includegraphics{ubuntu}, Windows \includegraphics{win}, QNX \includegraphics{qnx}.}
\cvitem{Tools}{IPython, Visual Studio, Eclipse, SQL Management Studio, Emacs, VIM, SVN, git, VirtualBox, \LaTeX{}.}
\section{Aptitudes}
Speech proficiency, learning desire, service attitude, proactive, self-learner, honor and ethics.
